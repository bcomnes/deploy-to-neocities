...
- `dist_dir`: The directory to deploy to [Neocities][nc]. Default: `public`. Don't deploy your root repo directory (e.g. `./`). It contains .git, .githib and other files that won't deploy properly to neocities. Keep it clean by keeping or building your site into a subdir and deploy that. 
