...
class NeocitiesAPIClient {
  constructor (apiKey, opts) {
    nanoassert(apiKey, 'must pass apiKey as first argument');
    nanoassert(typeof apiKey === 'string', 'apiKey must be a string');
    opts = Object.assign({
      url: 'https://neocities.org'
    });

    this.opts = opts;
    this.url = new Url.URL(opts.url);
  }

  get (method, args) {
    nanoassert(method, 'must pass method as first argument');
    let path = `/api/${method}`;
...
exports.NeocitiesAPIClient = NeocitiesAPIClient;
